...
public class ProductMgr {
	...
	private static ProductDAO dao = new ProductMySQLDAO(); //多态
//	private static ProductDAO dao = new DAOFactory().getUserDAO() ; //简单工厂
	private ProductMgr() {}
...
System.out.println(conditionStr);
	...
	public int find(List<Product> products, int pageNo, int pageSize, ProductSearchFormBean bean) {
		String queryStr = " where 1=1 ";//form中的参数 不知道哪个会被用户选中呢 这样做 可以向where后面添加and 这个条件没有意义
