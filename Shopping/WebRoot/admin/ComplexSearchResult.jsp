...
<!-- 把form中的参数们 先放进一个DTO对象searchBean中 1然后再传给业务逻辑层 2还可以验证 ProductSearchFormBean 中有validate -->
<jsp:useBean id="searchBean" class="com.bjsxt.shopping.product.ProductSearchFormBean">
	<jsp:setProperty name="searchBean" property="*" />
</jsp:useBean>

<!-- Data Transfer Object 1.验证 2.把form里面的数据传送到业务逻辑层-->

<jsp:getProperty name="searchBean" property="categoryId"/><br/>
<jsp:getProperty name="searchBean" property="name"/><br/>
<jsp:getProperty name="searchBean" property="lowNormalPrice"/><br/>
<jsp:getProperty name="searchBean" property="highNormalPrice"/><br/>
<jsp:getProperty name="searchBean" property="lowMemberPrice"/><br/>
<jsp:getProperty name="searchBean" property="highMemberPrice"/><br/>
<jsp:getProperty name="searchBean" property="startDate"/><br/>
<jsp:getProperty name="searchBean" property="endDate"/><br/>
