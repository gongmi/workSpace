...
<%
String s=request.getParameter("ID");           //拿到上一个页面传过来的id

int id=Integer.parseInt(s);
List<Article> articles=new ArrayList<>();

Article A=Tree.flat_detail(articles, id); 
...
<div id="jive-flatpage">
  ...
  <div class="jive-buttons">
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td class="jive-icon">                             <a href="reply.jsp?RootID=<%=A.getRootid()%>&ID=<%=A.getId()%>"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a></td>
          <td class="jive-icon-label"><a id="jive-reply-thread" href="reply.jsp?RootID=<%=A.getRootid()%>&ID=<%=A.getId()%>">回复本主题</a> </td>
        </tr>
      </tbody>
    </table>
  </div>
...
if (a.equals(A)) 
	sTitle="楼主:"+a.getTitle();  

else
 
	sTitle="第"+(i-1)+"楼:"+a.getTitle();
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"><%=sTitle%></span> </td>
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="reply.jsp?RootID=<%=a.getRootid()%>&ID=<%=a.getId()%>" title="回复本主题"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a> </td>
                                          <td class="jive-icon-label"><a href="reply.jsp?RootID=<%=a.getRootid()%>&ID=<%=a.getId()%>" title="回复本主题">回复</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
