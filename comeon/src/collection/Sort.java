...
public final class Sort<T extends Comparable<? super T>> {
	 ...
	 * 
	 * for( theSeed = 0; theSeed < 20; theSeed++ ) { Random.permute( a );
	 * Sort.insertionSort( a ); checkSort( a );
	 * 
	 * Random.permute( a ); Sort.heapsort( a ); checkSort( a );
	 * 
	 * Random.permute( a ); Sort.shellsort( a ); checkSort( a );
	 * 
	 * Random.permute( a ); Sort.mergeSort( a ); checkSort( a );
	 * 
	 * Random.permute( a ); Sort.quicksort( a ); checkSort( a );
	 * 
	 * Random.permute( a ); Sort.quickSelect( a, NUM_ITEMS / 2 );
	 * System.out.println( a[ NUM_ITEMS / 2 - 1 ] + " " + NUM_ITEMS / 2 ); }
	 * 
	 * 
	 * Integer [ ] b = new Integer[ 10_000_000 ]; for( int i = 0; i < b.length;
	 * i++ ) b[ i ] = i;
	 * 
	 * Random.permute( b ); long start = System.currentTimeMillis( );
	 * Sort.quickSelect( b, b.length / 2 ); long end = System.currentTimeMillis(
	 * ); System.out.println( "Timing for Section 1.1 example: " );
	 * System.out.println( "Selection for N = " + b.length + " takes " + ( end -
	 * start ) + "ms." ); System.out.println( b[ b.length / 2 - 1 ] + " " +
	 * b.length / 2 ); }
	 */
}
